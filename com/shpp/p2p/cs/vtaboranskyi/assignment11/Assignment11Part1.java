...
public class Assignment11Part1 {
    ...
    public static final String[] FUNCTIONS = {"sin", "cos", "atan", "tan", "log10", "log2", "sqrt"};
    ...
    public static void main(String[] args) {
        ...
        formula = prepareForCalculation(formula, vars);
    ...
    private static boolean isCharVar(String formula, int index) {
    ...
    private static String prepareForCalculation(String formula, HashMap<String, Double> vars) {
        if (vars != null)
    ...
    private static double calculate(String formula) {
        if (formula.contains("(") || formula.contains(")")) {
            ...
            formula = calcAllBrackets(formula);
        }

        formula = calcFunctions(formula);
    ...
    private static String calcFunctions(String formula) {
    ...
    private static String calcAllBrackets(String formula) {
        ...
        while (formula.contains("(")) {
            ...
            for (int i = openIndex + 1; i < closeIndex; i++)
                subFormula += formula.charAt(i);

            double subResult = calculate(subFormula);
