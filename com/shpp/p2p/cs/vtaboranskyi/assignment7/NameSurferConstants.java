...
public interface NameSurferConstants {
    ...
    /**
     * The colors used repeatedly to distinguish entries
     */
    public static final Color[] COLORS = {Color.BLUE, Color.RED, Color.MAGENTA, Color.BLACK};

    /**
     * The columns number set for the name input field.
     */
    public static final int INPUT_COLS = 20;

    /**
     * The years number between two decades edges.
     */
    public static final int DECADES_GAP = 10;

    /**
     * The ranks' and decades' font's parameters, respectively.
     */
    public static final String RANK_FONT = "Areal-10";
    public static final String DECADE_FONT = "Areal-bold-14";
