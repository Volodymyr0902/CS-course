...
public class ExploreUA extends TextProgram {
    ...
    private static final String CITIES_FILE = "shpp-cs-a-uacities-ptypes.txt";
    ...
    public void run() {
        ...
        while (true) {
            ...
            cityName = removeSymbols(cityName);
    ...
    private String removeSymbols(String cityName) {
        String cleanedName = "";
        for (int i = 0; i < cityName.length(); i++) {
            char x = cityName.charAt(i);
