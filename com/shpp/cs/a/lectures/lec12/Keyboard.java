...
public class Keyboard extends WindowProgram {
    ...
    private static final String KEYBOARD_FILE = "keyboard/keyboard.txt";
    ...
    private HashMap<GObject, String> soundMap = new HashMap<GObject, String>();
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (soundMap.containsKey(hit)) {
            StdAudio.playInBackground(soundMap.get(hit));
        }
    }
    ...
    private void addKeyboard() {
        try {
            ...
            while (true) {
                ...
                soundMap.put(key, "keyboard/"+note);
            }
