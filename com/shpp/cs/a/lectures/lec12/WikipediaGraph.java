...
public class WikipediaGraph extends TextProgram {
    ...
    private static final String ARTICLES_FILE = "Data/articles.txt";

    /* The file containing the links between the articles. */
    private static final String LINKS_FILE = "Data/links.txt";
    ...
    private static final int NUM_DISPLAYED_RESULTS = 100;
